...
## hri_msgs (noetic) - 0.8.0-1

The packages in the `hri_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release hri_msgs -r noetic` on `Thu, 06 Oct 2022 08:18:00 -0000`
...
## hri_msgs (melodic) - 0.8.0-1

The packages in the `hri_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hri_msgs -r melodic` on `Wed, 31 Aug 2022 13:49:37 -0000`
...
## hri_msgs (noetic) - 0.7.1-1

The packages in the `hri_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release hri_msgs -r noetic` on `Wed, 20 Jul 2022 09:51:31 -0000`
...
## hri_msgs (melodic) - 0.7.1-1

The packages in the `hri_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hri_msgs -r melodic` on `Wed, 20 Jul 2022 09:50:17 -0000`
...
## hri_msgs (melodic) - 0.7.0-1

The packages in the `hri_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hri_msgs -r melodic` on `Tue, 28 Jun 2022 14:30:43 -0000`
...
## hri_msgs (noetic) - 0.7.0-1

The packages in the `hri_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release hri_msgs -r noetic` on `Tue, 28 Jun 2022 14:27:33 -0000`
...
## hri_msgs (noetic) - 0.5.2-1

The packages in the `hri_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release hri_msgs -r noetic` on `Wed, 04 May 2022 13:03:39 -0000`
...
## hri_msgs (melodic) - 0.5.2-1

The packages in the `hri_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release hri_msgs -r melodic` on `Wed, 04 May 2022 13:01:53 -0000`
...
## hri_msgs (melodic) - 0.4.1-1

The packages in the `hri_msgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic hri_msgs --edit` on `Wed, 26 Jan 2022 08:40:43 -0000`
